...
RI_7_3 = numeric(repeat_times)
MSE_7_3 = numeric(repeat_times)
RTO_7_3 = numeric(repeat_times)
for (t in 1:repeat_times) {
  ...
  fgsg_1 = ncTFGS(X.sis.tilde,y,graph,0.005,0.03)
