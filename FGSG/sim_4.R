...
relist = foreach(t=1:repeat_times)%dopar%{
  set.seed(seed[t])
  options(digits = 4)
  ntr = 200
  p = 200
  b = 0
  beta1_true = c(-4,-4,0,0,rep(0,p-4))
  beta2_true = c(0,0,4,4,rep(0,p-4))
  ...
  beta1 = ifelse(class1, -4, 0) 
  beta2 = ifelse(class1, -4, 0)
  beta3 = ifelse(class1, 0, 4)
  beta4 = ifelse(class1, 0, 4) ## slope
  num = rep(0,ntr)
  ...
  fgsg_1 = ncFGS(X.sis.tilde,y,graph,0.001,0.0015)
  ...
  result =  list(RI = RI_fgsg,MSE = mse_fgsg,RTO = RTO_fgsg)
  result
}

s4 = read.table("C://Users//86187//Desktop//同质和异质变量区分//txt结果//s4.txt",sep = " ")
RI_tf_4 = s4$RI
MSE_tf_4 = s4$mse_fit
RTO_tf_4 = s4$RTO
